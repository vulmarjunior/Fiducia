...
- `src/components/reports/CashFlowChart.tsx` — tabela de conferência atualizada para exibir o **Saldo Previsto** na coluna de saldo e no rodapé totalizador quando a opção "Pendentes" estiver ativada.
