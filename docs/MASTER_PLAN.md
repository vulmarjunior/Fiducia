...
| **Última alteração em código** | 2026-09-05 (Navegação Temporal e Visualização Diária no Simulador v0.19.1) |
| **Último deploy** | v0.15.5 em produção (v0.19.1 pronta para deploy) |
