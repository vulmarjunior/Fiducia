...
| **Última alteração em código** | 2026-09-05 (Alinhamento do Card do Dashboard e Filtro Anual Civil v0.18.2) |
| **Último deploy** | v0.15.5 em produção (v0.18.2 pronta para deploy) |
