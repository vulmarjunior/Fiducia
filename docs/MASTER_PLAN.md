...
| **Última alteração em código** | 2026-09-05 (Simulador de Decisões de Caixa baseado em Entradas × Saídas Mensal v0.19.0) |
| **Último deploy** | v0.15.5 em produção (v0.19.0 pronta para deploy) |
